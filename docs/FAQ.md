...
1.	[Frequently Asked Questions](#frequently-asked-questions)
	...
	2.	[General Questions](#general-questions)
        ...
        11.  [How can I reduce disk consumption?](how-can-i-reduce-disk-consumption)
...
### How can I reduce disk consumption?

You can enable [pruning](https://besu.hyperledger.org/en/stable/Concepts/Pruning/) if you want to reduce disk consumption for storing network blocks. Keep in mind that activating pruning will keep the x [latest blocks](https://besu.hyperledger.org/en/stable/Reference/CLI/CLI-Syntax/#pruning-blocks-retained) wanted by the organization, this means that if you want to get older blocks you will not be able to do it from your node.
